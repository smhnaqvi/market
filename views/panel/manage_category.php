<div class="row">
    <div class="col-md-4 col-sm-12 mb-5">
        <form action="<?= base_url("panel/category/add-new") ?>" method="post">
                    ...
                    <td>
                        <div class="dropdown show text-left">
                            ...
                            <div class="dropdown-menu text-center">
                                <a class="dropdown-item" href="<?= base_url("panel/category/$item->id/manage-subcategories") ?>">مدریت زیر دسته</a>
                                <a class="dropdown-item" href="<?= base_url("panel/category/$item->id/edit") ?>">ویرایش</a>
                                <a class="dropdown-item" href="<?= base_url("panel/category/$item->id/delete") ?>">حذف</a>
                            </div>
                        </div>
                    </td>
                </tr>
