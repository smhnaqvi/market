<div class="container">
    ...
    <div class="row">
        <?php if (!empty($content["products"]["products"])) : ?>
            <div class="col-md-12  products-list">
                <?php foreach ($content["products"]["products"] as $product) : ?>
                    <div data-rowId="" data-id="<?= $product->product_id ?>" class="product-item">
        ...
        <?php else: ?>
            <div style="font-size: 14pt" class="alert alert-warning d-flex justify-content-center align-items-center w-100" role="alert">نتیجه ای یافت نشد</div>
        <?php endif ?>
    </div>
</div>