    ...
    <?php foreach ($content["products"]["products"] as $product) : ?>
        <div class="card mb-3">
            <div class="card-body align-items-center p-0">
                ...
                <div data-id="<?= $product->product_id ?>" class="product-info">
                ...
                <div class="product-addCart">
                    ...
                    <button onclick="addToBasket(this)" class="btn btn-sm btn-primary" style="font-size: 12px;"><i
                                class="fal fa-shopping-basket ml-2"></i>خرید
                    </button>
                </div>
            </div>
        </div>
