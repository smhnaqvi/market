<div class="py-5 text-center d-none">
    <h2>سفارش محصولات</h2>
    <p class="lead">شما میتوانید براحتی محصولات مورد نیاز خود را از این فروشگاه با قیمتی مناسب و بصورت آنلاین خریداری
        ...
        <form action="<?= base_url("order/new-request") ?>" method="post" class="text-right _font-size">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="number" name="mobileNumber" class="form-control _font-size" id="mobileNumber"
